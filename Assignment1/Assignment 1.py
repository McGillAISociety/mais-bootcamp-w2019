...
logreg = LogisticRegression(C=4, multi_class='multinomial', solver='saga', tol=0.1)
...
randForest = RandomForestClassifier(n_estimators=200, min_samples_split=3, max_features=0.1)
