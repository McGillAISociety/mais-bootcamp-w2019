...
print('training accuracy: ', accuracy_score(rforest.predict(X_train), y_train))
## YOUR CODE HERE - print test accuracy
print('test accuracy: ', accuracy_score(rforest.predict(X_test), y_test)) 
...
nn = MLPClassifier(hidden_layer_sizes=(150,), solver='adam', verbose=1)
