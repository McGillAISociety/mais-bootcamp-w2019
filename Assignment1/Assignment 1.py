...
logreg = LogisticRegression(C=0.05, multi_class='multinomial', solver='saga', tol=0.1)
...
rfc = RandomForestClassifier(n_estimators=100, min_samples_split=2, max_features='sqrt')
...
rsvc = SVC(kernel='rbf', tol=0.01, cache_size=4000, gamma='auto', C=2)
...
nn = MLPClassifier(hidden_layer_sizes=(350,150), solver='adam', verbose=1)
