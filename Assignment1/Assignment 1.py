...
forest = RandomForestClassifier(5, min_samples_split = 5, max_features = 200)
...
print('train acc: ', accuracy_score(forest.predict(X_train).argmax(axis=1), y_train))

## YOUR CODE HERE - print test accuracy
print('test acc: ', accuracy_score(forest.predict(X_test).argmax(axis=1), y_test))
...
## YOUR CODE HERE - print training accuracy
print('train acc: ', accuracy_score(nn.predict(X_train).argmax(axis=1), y_train))

## YOUR CODE HERE - print test accuracy
print('test acc: ', accuracy_score(nn.predict(X_test).argmax(axis=1), y_test))
