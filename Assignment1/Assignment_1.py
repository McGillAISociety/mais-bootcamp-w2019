...
logreg = LogisticRegression(C=0.20, multi_class='multinomial', solver='saga', tol=0.1)
...
rf = RandomForestClassifier(n_estimators=500,min_samples_split=10,max_features='auto')
