...
from keras.layers import Reshape, AveragePooling2D, MaxPooling2D, ZeroPadding2D, Dropout
...
BATCH_SIZE = 1024 # Reduce this to 256, 128, 64, etc if your computer is too slow
...
model.fit(x=X_train, y=y_train_enc, epochs=23, batch_size=BATCH_SIZE)
